...
(cl:defclass <MissionHpUpload-request> (roslisp-msg-protocol:ros-message)
  ((hotpoint_task
    ...
    :type dji_osdk_ros-msg:MissionHotpointTask
    :initform (cl:make-instance 'dji_osdk_ros-msg:MissionHotpointTask)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MissionHpUpload-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionHpUpload-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<MissionHpUpload-request> is deprecated: use dji_osdk_ros-srv:MissionHpUpload-request instead.")))

(cl:ensure-generic-function 'hotpoint_task-val :lambda-list '(m))
(cl:defmethod hotpoint_task-val ((m <MissionHpUpload-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:hotpoint_task-val is deprecated.  Use dji_osdk_ros-srv:hotpoint_task instead.")
  (hotpoint_task m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionHpUpload-request>)))
  ...
  "dji_osdk_ros/MissionHpUploadRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionHpUpload-request)))
  "Returns string type for a service object of type 'MissionHpUpload-request"
  "dji_osdk_ros/MissionHpUploadRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MissionHpUpload-request>)))
  ...
  (cl:format cl:nil "MissionHotpointTask hotpoint_task~%~%================================================================================~%MSG: dji_osdk_ros/MissionHotpointTask~%float64 latitude  # degree~%float64 longitude # degree~%float64 altitude  # meter~%float64 radius    # meter~%float32 angular_speed #deg/s~%uint8 is_clockwise~%uint8 start_point~%uint8 yaw_mode~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MissionHpUpload-request)))
  "Returns full string definition for message of type 'MissionHpUpload-request"
  (cl:format cl:nil "MissionHotpointTask hotpoint_task~%~%================================================================================~%MSG: dji_osdk_ros/MissionHotpointTask~%float64 latitude  # degree~%float64 longitude # degree~%float64 altitude  # meter~%float64 radius    # meter~%float32 angular_speed #deg/s~%uint8 is_clockwise~%uint8 start_point~%uint8 yaw_mode~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <MissionHpUpload-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionHpUpload-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<MissionHpUpload-response> is deprecated: use dji_osdk_ros-srv:MissionHpUpload-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionHpUpload-response>)))
  ...
  "dji_osdk_ros/MissionHpUploadResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionHpUpload-response)))
  "Returns string type for a service object of type 'MissionHpUpload-response"
  "dji_osdk_ros/MissionHpUploadResponse")
