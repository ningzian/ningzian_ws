// Generated by gencpp from file dji_osdk_ros/MissionWaypoint.msg
// DO NOT EDIT!


#ifndef DJI_OSDK_ROS_MESSAGE_MISSIONWAYPOINT_H
#define DJI_OSDK_ROS_MESSAGE_MISSIONWAYPOINT_H
...
#include <dji_osdk_ros/MissionWaypointAction.h>
...
struct MissionWaypoint_
{
  ...
  _action_time_limit_type action_time_limit;
   ...
   typedef  ::dji_osdk_ros::MissionWaypointAction_<ContainerAllocator>  _waypoint_action_type;
  ...
  typedef boost::shared_ptr< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> const> ConstPtr;

}; // struct MissionWaypoint_

typedef ::dji_osdk_ros::MissionWaypoint_<std::allocator<void> > MissionWaypoint;

typedef boost::shared_ptr< ::dji_osdk_ros::MissionWaypoint > MissionWaypointPtr;
typedef boost::shared_ptr< ::dji_osdk_ros::MissionWaypoint const> MissionWaypointConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x22e006a33239b0ddULL;
  static const uint64_t static_value2 = 0x80a9840e2fb0dd19ULL;
};

template<class ContainerAllocator>
struct DataType< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dji_osdk_ros/MissionWaypoint";
  }
...
template<class ContainerAllocator>
struct Definition< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dji_osdk_ros::MissionWaypoint_<ContainerAllocator>& v)
  {
    s << indent << "latitude: ";
    ...
    s << std::endl;
    Printer< ::dji_osdk_ros::MissionWaypointAction_<ContainerAllocator> >::stream(s, indent + "  ", v.waypoint_action);
  }
};
...
#endif // DJI_OSDK_ROS_MESSAGE_MISSIONWAYPOINT_H
