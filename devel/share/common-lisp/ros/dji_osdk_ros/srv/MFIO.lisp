...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MFIO-request>)))
  ...
  (cl:format cl:nil "~%uint8 MODE_PWM_OUT  = 0~%~%uint8 MODE_GPIO_OUT = 2~%uint8 MODE_GPIO_IN  = 3~%uint8 MODE_ADC      = 4~%~%uint8 CHANNEL_0 = 0~%uint8 CHANNEL_1 = 1~%uint8 CHANNEL_2 = 2~%uint8 CHANNEL_3 = 3~%uint8 CHANNEL_4 = 4~%uint8 CHANNEL_5 = 5~%uint8 CHANNEL_6 = 6~%uint8 CHANNEL_7 = 7~%~%uint8 TURN_ON   = 0~%uint8 TURN_OFF  = 1~%~%~%uint8 action~%uint8 mode~%bool block~%uint8 channel~%uint32 init_on_time_us~%uint8 gpio_value~%uint16 pwm_freq~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MFIO-request)))
  "Returns full string definition for message of type 'MFIO-request"
  (cl:format cl:nil "~%uint8 MODE_PWM_OUT  = 0~%~%uint8 MODE_GPIO_OUT = 2~%uint8 MODE_GPIO_IN  = 3~%uint8 MODE_ADC      = 4~%~%uint8 CHANNEL_0 = 0~%uint8 CHANNEL_1 = 1~%uint8 CHANNEL_2 = 2~%uint8 CHANNEL_3 = 3~%uint8 CHANNEL_4 = 4~%uint8 CHANNEL_5 = 5~%uint8 CHANNEL_6 = 6~%uint8 CHANNEL_7 = 7~%~%uint8 TURN_ON   = 0~%uint8 TURN_OFF  = 1~%~%~%uint8 action~%uint8 mode~%bool block~%uint8 channel~%uint32 init_on_time_us~%uint8 gpio_value~%uint16 pwm_freq~%~%~%"))
