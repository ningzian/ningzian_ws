...
;//! \htmlinclude InitWaypointV2Setting-request.msg.html

(cl:defclass <InitWaypointV2Setting-request> (roslisp-msg-protocol:ros-message)
  ((waypointV2InitSettings
    :reader waypointV2InitSettings
    :initarg :waypointV2InitSettings
    :type dji_osdk_ros-msg:WaypointV2InitSetting
    :initform (cl:make-instance 'dji_osdk_ros-msg:WaypointV2InitSetting))
   (polygonNum
    :reader polygonNum
    :initarg :polygonNum
    :type cl:fixnum
...
(cl:defclass InitWaypointV2Setting-request (<InitWaypointV2Setting-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <InitWaypointV2Setting-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'InitWaypointV2Setting-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<InitWaypointV2Setting-request> is deprecated: use dji_osdk_ros-srv:InitWaypointV2Setting-request instead.")))

(cl:ensure-generic-function 'waypointV2InitSettings-val :lambda-list '(m))
(cl:defmethod waypointV2InitSettings-val ((m <InitWaypointV2Setting-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:waypointV2InitSettings-val is deprecated.  Use dji_osdk_ros-srv:waypointV2InitSettings instead.")
  (waypointV2InitSettings m))

(cl:ensure-generic-function 'polygonNum-val :lambda-list '(m))
(cl:defmethod polygonNum-val ((m <InitWaypointV2Setting-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:polygonNum-val is deprecated.  Use dji_osdk_ros-srv:polygonNum instead.")
  (polygonNum m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <InitWaypointV2Setting-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:radius-val is deprecated.  Use dji_osdk_ros-srv:radius instead.")
  (radius m))

(cl:ensure-generic-function 'actionNum-val :lambda-list '(m))
(cl:defmethod actionNum-val ((m <InitWaypointV2Setting-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:actionNum-val is deprecated.  Use dji_osdk_ros-srv:actionNum instead.")
  (actionNum m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <InitWaypointV2Setting-request>) ostream)
  "Serializes a message object of type '<InitWaypointV2Setting-request>"
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'waypointV2InitSettings) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'polygonNum)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'polygonNum)) ostream)
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'radius))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'actionNum)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'actionNum)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <InitWaypointV2Setting-request>) istream)
  "Deserializes a message object of type '<InitWaypointV2Setting-request>"
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'waypointV2InitSettings) istream)
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'polygonNum)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'polygonNum)) (cl:read-byte istream))
    (cl:let ((bits 0))
...
(cl:defclass InitWaypointV2Setting-response (<InitWaypointV2Setting-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <InitWaypointV2Setting-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'InitWaypointV2Setting-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<InitWaypointV2Setting-response> is deprecated: use dji_osdk_ros-srv:InitWaypointV2Setting-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <InitWaypointV2Setting-response>))
  ...
  (result m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <InitWaypointV2Setting-response>) ostream)
  "Serializes a message object of type '<InitWaypointV2Setting-response>"
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'result) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <InitWaypointV2Setting-response>) istream)
  "Deserializes a message object of type '<InitWaypointV2Setting-response>"
    (cl:setf (cl:slot-value msg 'result) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<InitWaypointV2Setting-response>)))
  "Returns string type for a service object of type '<InitWaypointV2Setting-response>"
  "dji_osdk_ros/InitWaypointV2SettingResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InitWaypointV2Setting-response)))
  "Returns string type for a service object of type 'InitWaypointV2Setting-response"
  "dji_osdk_ros/InitWaypointV2SettingResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<InitWaypointV2Setting-response>)))
  "Returns md5sum for a message object of type '<InitWaypointV2Setting-response>"
  "f07b42d879472cc58a4d50076253c8e6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'InitWaypointV2Setting-response)))
  "Returns md5sum for a message object of type 'InitWaypointV2Setting-response"
  "f07b42d879472cc58a4d50076253c8e6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<InitWaypointV2Setting-response>)))
  "Returns full string definition for message of type '<InitWaypointV2Setting-response>"
  (cl:format cl:nil "bool result~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'InitWaypointV2Setting-response)))
  "Returns full string definition for message of type 'InitWaypointV2Setting-response"
  (cl:format cl:nil "bool result~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <InitWaypointV2Setting-response>))
  (cl:+ 0
     1
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <InitWaypointV2Setting-response>))
  "Converts a ROS message object to a list"
  (cl:list 'InitWaypointV2Setting-response
    (cl:cons ':result (result msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'InitWaypointV2Setting)))
  'InitWaypointV2Setting-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'InitWaypointV2Setting)))
  'InitWaypointV2Setting-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InitWaypointV2Setting)))
  "Returns string type for a service object of type '<InitWaypointV2Setting>"
  "dji_osdk_ros/InitWaypointV2Setting")