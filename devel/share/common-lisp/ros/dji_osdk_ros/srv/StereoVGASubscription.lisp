...
(cl:defmethod cl:initialize-instance :after ((m <StereoVGASubscription-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StereoVGASubscription-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<StereoVGASubscription-request> is deprecated: use dji_osdk_ros-srv:StereoVGASubscription-request instead.")))

(cl:ensure-generic-function 'vga_freq-val :lambda-list '(m))
(cl:defmethod vga_freq-val ((m <StereoVGASubscription-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:vga_freq-val is deprecated.  Use dji_osdk_ros-srv:vga_freq instead.")
  (vga_freq m))

(cl:ensure-generic-function 'front_vga-val :lambda-list '(m))
(cl:defmethod front_vga-val ((m <StereoVGASubscription-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:front_vga-val is deprecated.  Use dji_osdk_ros-srv:front_vga instead.")
  (front_vga m))
...
(cl:defmethod unsubscribe_vga-val ((m <StereoVGASubscription-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:unsubscribe_vga-val is deprecated.  Use dji_osdk_ros-srv:unsubscribe_vga instead.")
  (unsubscribe_vga m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StereoVGASubscription-request>)))
  ...
  "dji_osdk_ros/StereoVGASubscriptionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StereoVGASubscription-request)))
  "Returns string type for a service object of type 'StereoVGASubscription-request"
  "dji_osdk_ros/StereoVGASubscriptionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <StereoVGASubscription-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StereoVGASubscription-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<StereoVGASubscription-response> is deprecated: use dji_osdk_ros-srv:StereoVGASubscription-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StereoVGASubscription-response>)))
  ...
  "dji_osdk_ros/StereoVGASubscriptionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StereoVGASubscription-response)))
  "Returns string type for a service object of type 'StereoVGASubscription-response"
  "dji_osdk_ros/StereoVGASubscriptionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StereoVGASubscription)))
  ...
  "dji_osdk_ros/StereoVGASubscription")