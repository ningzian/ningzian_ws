  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.actions:
        ...
        _v7 = _v5.zoomParam
        buff.write(_get_struct_H().pack(_v7.focalLength))
        ...
        buff.write(_get_struct_B().pack(_v11.isStartFlying))
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.actions:
        ...
        buff.write(_get_struct_2fB2f().pack(_x.x, _x.y, _x.regionType, _x.width, _x.height))
        _v31 = _v29.zoomParam
        buff.write(_get_struct_H().pack(_v31.focalLength))
        ...
        buff.write(_get_struct_B().pack(_v35.isStartFlying))
