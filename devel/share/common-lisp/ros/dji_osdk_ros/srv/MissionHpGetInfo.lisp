...
(cl:defmethod cl:initialize-instance :after ((m <MissionHpGetInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionHpGetInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<MissionHpGetInfo-request> is deprecated: use dji_osdk_ros-srv:MissionHpGetInfo-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionHpGetInfo-request>)))
  ...
  "dji_osdk_ros/MissionHpGetInfoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionHpGetInfo-request)))
  "Returns string type for a service object of type 'MissionHpGetInfo-request"
  "dji_osdk_ros/MissionHpGetInfoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MissionHpGetInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionHpGetInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<MissionHpGetInfo-response> is deprecated: use dji_osdk_ros-srv:MissionHpGetInfo-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionHpGetInfo-response>)))
  ...
  "dji_osdk_ros/MissionHpGetInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionHpGetInfo-response)))
  "Returns string type for a service object of type 'MissionHpGetInfo-response"
  "dji_osdk_ros/MissionHpGetInfoResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MissionHpGetInfo-response>)))
  ...
  (cl:format cl:nil "MissionHotpointTask hotpoint_task~%~%uint8 cmd_set~%uint8 cmd_id~%uint32 ack_data~%~%================================================================================~%MSG: dji_osdk_ros/MissionHotpointTask~%float64 latitude  # degree~%float64 longitude # degree~%float64 altitude  # meter~%float64 radius    # meter~%float32 angular_speed #deg/s~%uint8 is_clockwise~%uint8 start_point~%uint8 yaw_mode~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MissionHpGetInfo-response)))
  "Returns full string definition for message of type 'MissionHpGetInfo-response"
  (cl:format cl:nil "MissionHotpointTask hotpoint_task~%~%uint8 cmd_set~%uint8 cmd_id~%uint32 ack_data~%~%================================================================================~%MSG: dji_osdk_ros/MissionHotpointTask~%float64 latitude  # degree~%float64 longitude # degree~%float64 altitude  # meter~%float64 radius    # meter~%float32 angular_speed #deg/s~%uint8 is_clockwise~%uint8 start_point~%uint8 yaw_mode~%~%~%"))
