...
"""autogenerated by genpy from dji_osdk_ros/MissionWaypoint.msg. Do not edit."""
import sys
...
class MissionWaypoint(genpy.Message):
  ...
  _type = "dji_osdk_ros/MissionWaypoint"
...
"""
  ...
  _slot_types = ['float64','float64','float32','float32','int16','int16','uint8','uint8','uint16','dji_osdk_ros/MissionWaypointAction']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.waypoint_action is None:
        self.waypoint_action = dji_osdk_ros.msg.MissionWaypointAction()
    else:
      self.latitude = 0.
      self.longitude = 0.
      self.altitude = 0.
