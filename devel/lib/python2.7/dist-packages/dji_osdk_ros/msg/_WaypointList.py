...
"""autogenerated by genpy from dji_osdk_ros/WaypointList.msg. Do not edit."""
import sys
...
class WaypointList(genpy.Message):
  ...
  _type = "dji_osdk_ros/WaypointList"
...
"""
  ...
  _slot_types = ['dji_osdk_ros/Waypoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = dji_osdk_ros.msg.Waypoint()
        _x = val1
        start = end
        end += 24
