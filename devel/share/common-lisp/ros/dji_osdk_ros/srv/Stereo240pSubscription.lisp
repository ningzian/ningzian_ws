...
(cl:defmethod cl:initialize-instance :after ((m <Stereo240pSubscription-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stereo240pSubscription-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<Stereo240pSubscription-request> is deprecated: use dji_osdk_ros-srv:Stereo240pSubscription-request instead.")))
...
(cl:defmethod front_right_240p-val ((m <Stereo240pSubscription-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:front_right_240p-val is deprecated.  Use dji_osdk_ros-srv:front_right_240p instead.")
  (front_right_240p m))
...
(cl:defmethod front_left_240p-val ((m <Stereo240pSubscription-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:front_left_240p-val is deprecated.  Use dji_osdk_ros-srv:front_left_240p instead.")
  (front_left_240p m))
...
(cl:defmethod down_front_240p-val ((m <Stereo240pSubscription-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:down_front_240p-val is deprecated.  Use dji_osdk_ros-srv:down_front_240p instead.")
  (down_front_240p m))
...
(cl:defmethod down_back_240p-val ((m <Stereo240pSubscription-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:down_back_240p-val is deprecated.  Use dji_osdk_ros-srv:down_back_240p instead.")
  (down_back_240p m))
...
(cl:defmethod unsubscribe_240p-val ((m <Stereo240pSubscription-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:unsubscribe_240p-val is deprecated.  Use dji_osdk_ros-srv:unsubscribe_240p instead.")
  (unsubscribe_240p m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Stereo240pSubscription-request>)))
  ...
  "dji_osdk_ros/Stereo240pSubscriptionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Stereo240pSubscription-request)))
  "Returns string type for a service object of type 'Stereo240pSubscription-request"
  "dji_osdk_ros/Stereo240pSubscriptionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Stereo240pSubscription-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stereo240pSubscription-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<Stereo240pSubscription-response> is deprecated: use dji_osdk_ros-srv:Stereo240pSubscription-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Stereo240pSubscription-response>)))
  ...
  "dji_osdk_ros/Stereo240pSubscriptionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Stereo240pSubscription-response)))
  "Returns string type for a service object of type 'Stereo240pSubscription-response"
  "dji_osdk_ros/Stereo240pSubscriptionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Stereo240pSubscription)))
  ...
  "dji_osdk_ros/Stereo240pSubscription")