...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetHMSData-response>)))
  ...
  (cl:format cl:nil "~%bool result~%uint8 deviceIndex~%~%HMSPushInfo[] errList~%uint32 timeStamp~%~%================================================================================~%MSG: dji_osdk_ros/HMSPushInfo~%uint32 alarmID     #/*! error code*/~%uint8  sensorIndex #/*! fault sensor's index*/~%uint8  reportLevel #/*! fault level ,0-4,0 is no error,4 is highest*/~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetHMSData-response)))
  "Returns full string definition for message of type 'GetHMSData-response"
  (cl:format cl:nil "~%bool result~%uint8 deviceIndex~%~%HMSPushInfo[] errList~%uint32 timeStamp~%~%================================================================================~%MSG: dji_osdk_ros/HMSPushInfo~%uint32 alarmID     #/*! error code*/~%uint8  sensorIndex #/*! fault sensor's index*/~%uint8  reportLevel #/*! fault level ,0-4,0 is no error,4 is highest*/~%~%"))
