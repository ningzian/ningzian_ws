...
(cl:defmethod cl:initialize-instance :after ((m <SetHardSync-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetHardSync-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<SetHardSync-request> is deprecated: use dji_osdk_ros-srv:SetHardSync-request instead.")))

(cl:ensure-generic-function 'frequency-val :lambda-list '(m))
(cl:defmethod frequency-val ((m <SetHardSync-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:frequency-val is deprecated.  Use dji_osdk_ros-srv:frequency instead.")
  (frequency m))

(cl:ensure-generic-function 'tag-val :lambda-list '(m))
(cl:defmethod tag-val ((m <SetHardSync-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:tag-val is deprecated.  Use dji_osdk_ros-srv:tag instead.")
  (tag m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetHardSync-request>)))
  ...
  "dji_osdk_ros/SetHardSyncRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetHardSync-request)))
  "Returns string type for a service object of type 'SetHardSync-request"
  "dji_osdk_ros/SetHardSyncRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetHardSync-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetHardSync-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<SetHardSync-response> is deprecated: use dji_osdk_ros-srv:SetHardSync-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetHardSync-response>)))
  ...
  "dji_osdk_ros/SetHardSyncResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetHardSync-response)))
  "Returns string type for a service object of type 'SetHardSync-response"
  "dji_osdk_ros/SetHardSyncResponse")
