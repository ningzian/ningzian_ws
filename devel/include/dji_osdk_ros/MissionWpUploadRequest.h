// Generated by gencpp from file dji_osdk_ros/MissionWpUploadRequest.msg
// DO NOT EDIT!


#ifndef DJI_OSDK_ROS_MESSAGE_MISSIONWPUPLOADREQUEST_H
#define DJI_OSDK_ROS_MESSAGE_MISSIONWPUPLOADREQUEST_H
...
#include <dji_osdk_ros/MissionWaypointTask.h>

namespace dji_osdk_ros
{
template <class ContainerAllocator>
struct MissionWpUploadRequest_
{
  typedef MissionWpUploadRequest_<ContainerAllocator> Type;

  MissionWpUploadRequest_()
    : waypoint_task()  {
    }
  MissionWpUploadRequest_(const ContainerAllocator& _alloc)
  ...
  (void)_alloc;
   ...
   typedef  ::dji_osdk_ros::MissionWaypointTask_<ContainerAllocator>  _waypoint_task_type;
  ...
  typedef boost::shared_ptr< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> const> ConstPtr;

}; // struct MissionWpUploadRequest_

typedef ::dji_osdk_ros::MissionWpUploadRequest_<std::allocator<void> > MissionWpUploadRequest;

typedef boost::shared_ptr< ::dji_osdk_ros::MissionWpUploadRequest > MissionWpUploadRequestPtr;
typedef boost::shared_ptr< ::dji_osdk_ros::MissionWpUploadRequest const> MissionWpUploadRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x412556517acb90aaULL;
  static const uint64_t static_value2 = 0x4c3e713fbb867865ULL;
};

template<class ContainerAllocator>
struct DataType< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dji_osdk_ros::MissionWpUploadRequest_<ContainerAllocator>& v)
  {
    s << indent << "waypoint_task: ";
    s << std::endl;
    Printer< ::dji_osdk_ros::MissionWaypointTask_<ContainerAllocator> >::stream(s, indent + "  ", v.waypoint_task);
  }
};
...
#endif // DJI_OSDK_ROS_MESSAGE_MISSIONWPUPLOADREQUEST_H
