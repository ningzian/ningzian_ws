// Generated by gencpp from file dji_osdk_ros/MissionWpGetInfoResponse.msg
// DO NOT EDIT!


#ifndef DJI_OSDK_ROS_MESSAGE_MISSIONWPGETINFORESPONSE_H
#define DJI_OSDK_ROS_MESSAGE_MISSIONWPGETINFORESPONSE_H
...
struct MissionWpGetInfoResponse_
{
  ...
  typedef boost::shared_ptr< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> const> ConstPtr;

}; // struct MissionWpGetInfoResponse_

typedef ::dji_osdk_ros::MissionWpGetInfoResponse_<std::allocator<void> > MissionWpGetInfoResponse;

typedef boost::shared_ptr< ::dji_osdk_ros::MissionWpGetInfoResponse > MissionWpGetInfoResponsePtr;
typedef boost::shared_ptr< ::dji_osdk_ros::MissionWpGetInfoResponse const> MissionWpGetInfoResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x412556517acb90aaULL;
  static const uint64_t static_value2 = 0x4c3e713fbb867865ULL;
};

template<class ContainerAllocator>
struct DataType< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dji_osdk_ros/MissionWpGetInfoResponse";
  }
...
template<class ContainerAllocator>
struct Definition< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator>& v)
  {
...
#endif // DJI_OSDK_ROS_MESSAGE_MISSIONWPGETINFORESPONSE_H
