// Generated by gencpp from file dji_osdk_ros/InitWaypointV2SettingRequest.msg
// DO NOT EDIT!


#ifndef DJI_OSDK_ROS_MESSAGE_INITWAYPOINTV2SETTINGREQUEST_H
#define DJI_OSDK_ROS_MESSAGE_INITWAYPOINTV2SETTINGREQUEST_H
...
struct InitWaypointV2SettingRequest_
{
  typedef InitWaypointV2SettingRequest_<ContainerAllocator> Type;

  InitWaypointV2SettingRequest_()
    : waypointV2InitSettings()
    , polygonNum(0)
    , radius(0.0)
    , actionNum(0)  {
    }
  InitWaypointV2SettingRequest_(const ContainerAllocator& _alloc)
    : waypointV2InitSettings(_alloc)
    , polygonNum(0)
    , radius(0.0)
    , actionNum(0)  {
  (void)_alloc;
   ...
   typedef  ::dji_osdk_ros::WaypointV2InitSetting_<ContainerAllocator>  _waypointV2InitSettings_type;
  _waypointV2InitSettings_type waypointV2InitSettings;

   typedef uint16_t _polygonNum_type;
  _polygonNum_type polygonNum;

   typedef float _radius_type;
  _radius_type radius;

   typedef uint16_t _actionNum_type;
  _actionNum_type actionNum;





  typedef boost::shared_ptr< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> const> ConstPtr;

}; // struct InitWaypointV2SettingRequest_

typedef ::dji_osdk_ros::InitWaypointV2SettingRequest_<std::allocator<void> > InitWaypointV2SettingRequest;

typedef boost::shared_ptr< ::dji_osdk_ros::InitWaypointV2SettingRequest > InitWaypointV2SettingRequestPtr;
typedef boost::shared_ptr< ::dji_osdk_ros::InitWaypointV2SettingRequest const> InitWaypointV2SettingRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6d453cf39ee209bdULL;
  static const uint64_t static_value2 = 0x1279263912725a56ULL;
};

template<class ContainerAllocator>
struct DataType< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.waypointV2InitSettings);
      stream.next(m.polygonNum);
      stream.next(m.radius);
      stream.next(m.actionNum);
    }
...
template<class ContainerAllocator>
struct Printer< ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dji_osdk_ros::InitWaypointV2SettingRequest_<ContainerAllocator>& v)
  {
    s << indent << "waypointV2InitSettings: ";
    s << std::endl;
    Printer< ::dji_osdk_ros::WaypointV2InitSetting_<ContainerAllocator> >::stream(s, indent + "  ", v.waypointV2InitSettings);
    s << indent << "polygonNum: ";
    Printer<uint16_t>::stream(s, indent + "  ", v.polygonNum);
    s << indent << "radius: ";
    Printer<float>::stream(s, indent + "  ", v.radius);
    s << indent << "actionNum: ";
    Printer<uint16_t>::stream(s, indent + "  ", v.actionNum);
  }
};
...
#endif // DJI_OSDK_ROS_MESSAGE_INITWAYPOINTV2SETTINGREQUEST_H
